...
<details style="padding: 10px; margin-top: 0px; margin-bottom: 20px;">
  <summary style="cursor: pointer; font-weight: bold; color: white;">Abstract</summary>
<sub> 
Public support is crucial for shaping effective development aid policies. The Development Engagement Lab (DEL) has conducted comprehensive surveys in France, Germany, Great Britain, and the U.S. to track and analyze public attitudes towards aid and support for developing countries. This paper presents multiple datasets curated by DEL, capturing nuanced shifts in public opinion and behavior alongside the underlying mechanisms explaining these attitudes and actions. The DEL's data comprises panel data from 2019 to 2023, repeated cross-sectional data from 2019 to 2024, and subject-specific surveys. We anticipate that DEL's data will provide valuable insights for scholars and policymakers researching global poverty and development.
</sub> 
</details>
